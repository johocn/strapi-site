...
describe('Custom fields 注册校验', () => {
  ...
  it('Order custom fields 应包含 posSessionId / orderType / refundedOrderId / shiftId / terminalCode / aggregatePayStatus', async () => {
  ...
  it('OrderLine custom fields 应包含 originalPrice / discount / memberPriceApplied / isGift / note', async () => {
